jQuery(document).ready(function(){
	...
	setInterval(ModificarAutomatico,99999);
	$(":input").inputmask();
...
$(document).on('click', '.next-button', function() {
	...
	var target = $(".section-container[data-order="+(parseInt(active)+1)+"]");
...
function AbrirModalFaltante(IdSeccion)
{
	...
	param += "&hashDirectorioLegislador="+$("#hashDirectorioLegislador").val();
	param += "&hashFormulario="+$("#hashFormulario").val();
	param += "&hashUsuarioBack="+$("#hashUsuarioBack").val();
